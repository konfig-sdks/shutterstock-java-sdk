...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.shutterstock.com";
    private String tokenUrl = "https://api.shutterstock.com/v2/oauth/access_token";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("customer_accessCode", oauth);
        return oauth;
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.1.32/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.shutterstock.com)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://api.shutterstock.com/v2/oauth/access_token)
     * @return An instance of OkHttpClient
     */
