 ...
 */
@ApiModel(description = "Media Recommendation")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Recommendation {
  ...
  **/
  ...
  @ApiModelProperty(example = "123456789X", required = true, value = "Media ID")
   ...
   * @return the Recommendation instance itself
   */
  public Recommendation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, recommendation.id)&&
        Objects.equals(this.additionalProperties, recommendation.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Recommendation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Recommendation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Recommendation>() {
           ...
           public Recommendation read(JsonReader in) throws IOException {
             ...
             Recommendation instance = thisAdapter.fromJsonTree(jsonObj);
