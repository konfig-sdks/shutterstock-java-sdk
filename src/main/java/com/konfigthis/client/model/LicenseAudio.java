 ...
 */
@ApiModel(description = "An audio track in a licensing request")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LicenseAudio {
  ...
  **/
  ...
  @ApiModelProperty(example = "123456789", required = true, value = "ID of the track being licensed")
  ...
  **/
  ...
  @ApiModelProperty(example = "AUDIO_PLATFORM", value = "Type of license")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "987654321", value = "ID of the search that led to this licensing event")
   ...
   * @return the LicenseAudio instance itself
   */
  public LicenseAudio putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.audioId, licenseAudio.audioId) &&
        ...
        Objects.equals(this.additionalProperties, licenseAudio.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(audioId, license, searchId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LicenseAudio
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LicenseAudio.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LicenseAudio>() {
           ...
           public LicenseAudio read(JsonReader in) throws IOException {
             ...
             LicenseAudio instance = thisAdapter.fromJsonTree(jsonObj);
