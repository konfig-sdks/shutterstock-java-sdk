...
public class LicenseImageVector {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EPS", value = "(Deprecated) Image format to download")
  ...
  **/
  ...
  public LicenseImageVector price(Double price) {
  ...
  public LicenseImageVector price(Integer price) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "VECTOR", value = "Image size to download")
  ...
  **/
   ...
   * @return the LicenseImageVector instance itself
   */
  public LicenseImageVector putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authCookie, licenseImageVector.authCookie) &&
        ...
        Objects.equals(this.additionalProperties, licenseImageVector.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authCookie, editorialAcknowledgement, format, imageId, metadata, price, searchId, showModal, size, subscriptionId, verificationCode, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LicenseImageVector
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LicenseImageVector.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LicenseImageVector>() {
           ...
           public LicenseImageVector read(JsonReader in) throws IOException {
             ...
             LicenseImageVector instance = thisAdapter.fromJsonTree(jsonObj);
