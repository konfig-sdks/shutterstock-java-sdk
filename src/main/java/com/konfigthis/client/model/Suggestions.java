 ...
 */
@ApiModel(description = "List of search suggestions")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Suggestions {
  ...
  **/
  ...
  @ApiModelProperty(value = "Search suggestions")
   ...
   * @return the Suggestions instance itself
   */
  public Suggestions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, suggestions.data)&&
        Objects.equals(this.additionalProperties, suggestions.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Suggestions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Suggestions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Suggestions>() {
           ...
           public Suggestions read(JsonReader in) throws IOException {
             ...
             Suggestions instance = thisAdapter.fromJsonTree(jsonObj);
