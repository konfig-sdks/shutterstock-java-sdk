 ...
 */
@ApiModel(description = "Information about a human model or property that appears in media; used to search for assets that this model is in")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Model {
  ...
  **/
  ...
  @ApiModelProperty(example = "123456789", required = true, value = "ID of the model")
