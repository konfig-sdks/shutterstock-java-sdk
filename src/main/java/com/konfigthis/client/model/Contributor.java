 ...
 */
@ApiModel(description = "Information about a contributor")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Contributor {
  ...
  **/
  ...
  @ApiModelProperty(example = "2847971", required = true, value = "ID of the contributor")
   ...
   * @return the Contributor instance itself
   */
  public Contributor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, contributor.id)&&
        Objects.equals(this.additionalProperties, contributor.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Contributor>() {
           ...
           public Contributor read(JsonReader in) throws IOException {
             ...
             Contributor instance = thisAdapter.fromJsonTree(jsonObj);
