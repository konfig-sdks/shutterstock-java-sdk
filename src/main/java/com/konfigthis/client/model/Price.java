 ...
 * Price
 */
@ApiModel(description = "Price")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Price {
  ...
  public Price localAmount(Double localAmount) {
  ...
  public Price localAmount(Integer localAmount) {
    
    
    
    
    this.localAmount = localAmount.doubleValue();
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "12.34", value = "Floating-point amount of the calculated rev-share price in the currency local_currency")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "EUR", value = "Currency of the rev-share price that was calculated")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(localAmount, localCurrency, additionalProperties);
  }
