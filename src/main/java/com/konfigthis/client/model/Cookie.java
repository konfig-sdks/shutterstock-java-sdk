...
public class Cookie {
  ...
  **/
   ...
   * @return the Cookie instance itself
   */
  public Cookie putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, cookie.name) &&
        ...
        Objects.equals(this.additionalProperties, cookie.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Cookie.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Cookie.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Cookie>() {
           ...
           public Cookie read(JsonReader in) throws IOException {
             ...
             Cookie instance = thisAdapter.fromJsonTree(jsonObj);
