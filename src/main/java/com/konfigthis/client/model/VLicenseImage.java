...
public class VLicenseImage {
 ...
 public enum SizeEnum {
  ...
  public VLicenseImage() {
  }

  public VLicenseImage authCookie(LicenseImageAuthCookie authCookie) {
  ...
  **/
  ...
  public VLicenseImage customDimensions(CustomSizeDimensions customDimensions) {
  ...
  **/
  ...
  public VLicenseImage editorialAcknowledgement(Boolean editorialAcknowledgement) {
  ...
  **/
  ...
  public VLicenseImage format(FormatEnum format) {
  ...
  **/
  ...
  public VLicenseImage imageId(String imageId) {
  ...
  **/
  ...
  public VLicenseImage metadata(Object metadata) {
  ...
  **/
  ...
  public VLicenseImage price(Double price) {
  ...
  public VLicenseImage price(Integer price) {
  ...
  **/
  ...
  public VLicenseImage searchId(String searchId) {
  ...
  **/
  ...
  public VLicenseImage showModal(Boolean showModal) {
  ...
  **/
  ...
  public VLicenseImage size(SizeEnum size) {
  ...
  **/
  ...
  public VLicenseImage subscriptionId(String subscriptionId) {
  ...
  **/
  ...
  public VLicenseImage verificationCode(String verificationCode) {
  ...
  **/
   ...
   * @return the VLicenseImage instance itself
   */
  public VLicenseImage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VLicenseImage vlicenseImage = (VLicenseImage) o;
    return Objects.equals(this.authCookie, vlicenseImage.authCookie) &&
        Objects.equals(this.customDimensions, vlicenseImage.customDimensions) &&
        Objects.equals(this.editorialAcknowledgement, vlicenseImage.editorialAcknowledgement) &&
        Objects.equals(this.format, vlicenseImage.format) &&
        Objects.equals(this.imageId, vlicenseImage.imageId) &&
        Objects.equals(this.metadata, vlicenseImage.metadata) &&
        Objects.equals(this.price, vlicenseImage.price) &&
        Objects.equals(this.searchId, vlicenseImage.searchId) &&
        Objects.equals(this.showModal, vlicenseImage.showModal) &&
        Objects.equals(this.size, vlicenseImage.size) &&
        Objects.equals(this.subscriptionId, vlicenseImage.subscriptionId) &&
        Objects.equals(this.verificationCode, vlicenseImage.verificationCode)&&
        Objects.equals(this.additionalProperties, vlicenseImage.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VLicenseImage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VLicenseImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VLicenseImage is not found in the empty JSON string", VLicenseImage.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VLicenseImage.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VLicenseImage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VLicenseImage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VLicenseImage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VLicenseImage.class));

       return (TypeAdapter<T>) new TypeAdapter<VLicenseImage>() {
           @Override
           public void write(JsonWriter out, VLicenseImage value) throws IOException {
           ...
           @Override
           public VLicenseImage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VLicenseImage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VLicenseImage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VLicenseImage
  * @throws IOException if the JSON string is invalid with respect to VLicenseImage
  */
  public static VLicenseImage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VLicenseImage.class);
  }

 /**
  * Convert an instance of VLicenseImage to an JSON string
  *
  * @return JSON string
  */
