 ...
 * Album metadata
 */
@ApiModel(description = "Album metadata")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Album {
  ...
  **/
  ...
  @ApiModelProperty(example = "Happy Music", required = true, value = "The album title")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1234567", required = true, value = "The album ID")
