 ...
 * Error object
 */
@ApiModel(description = "Error object")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error {
  ...
  **/
  ...
  @ApiModelProperty(example = "VALIDATION_INVALID_TYPE", value = "The error code of this error")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "'10'", value = "Debugging information about the error")
  ...
  public Error items(List<Object> items) {
  ...
  public Error addItemsItem(Object itemsItem) {
    if (this.items == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of items that produced the error")
  ...
  **/
  ...
  @ApiModelProperty(example = "Invalid type: string should be integer", required = true, value = "Specific details about this error")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "$.query.page", value = "Internal code reference to the source of the error")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error.code) &&
        ...
        Objects.equals(this.items, error.items) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, data, items, message, path, additionalProperties);
  }
