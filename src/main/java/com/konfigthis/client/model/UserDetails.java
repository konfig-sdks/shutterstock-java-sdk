 ...
 * User details
 */
@ApiModel(description = "User details")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UserDetails {
  ...
  private List<String> premierPermissions = null;
  ...
  **/
  ...
  @ApiModelProperty(example = "212", value = "Unique internal identifier of the user, as a contributor")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique internal identifier of the user, as a purchaser")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "John Doe", value = "Full name including first, middle, and last name of the user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "101782699", value = "Unique internal identifier for the user, not tied to contributor or purchasing customer")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "True if the user has access to the Premier collection, false otherwise")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "True if the user has access to the Premier collection and also has child users")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "es", value = "Main language of the user account")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "True if the user has an enterprise license, false otherwise")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "True if the user has access to sensitive use only, false otherwise")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Unique internal identifier for the user's organization, specific to Premier users")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of permissions allowed through the Premier client")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "jdoe", value = "User name associated to the user")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(contributorId, customerId, email, firstName, fullName, id, isPremier, isPremierParent, language, lastName, onlyEnhancedLicense, onlySensitiveUse, organizationId, premierPermissions, username, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("premier_permissions") != null && !jsonObj.get("premier_permissions").isJsonArray()) {
