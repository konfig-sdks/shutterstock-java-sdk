 ...
 */
@ApiModel(description = "Data required to license a video")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LicenseVideo {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether or not this item is editorial content")
  ...
  **/
  ...
  public LicenseVideo price(Double price) {
  ...
  public LicenseVideo price(Integer price) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Retail price amount as a floating-point number in the transaction currency, such as 12.34; only for rev-share partners")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "HD", value = "Size of the video being licensed")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "s12345678", value = "ID of the subscription used for this license")
  ...
  **/
  ...
  @ApiModelProperty(example = "2140697", required = true, value = "ID of the video being licensed")
   ...
   * @return the LicenseVideo instance itself
   */
  public LicenseVideo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authCookie, licenseVideo.authCookie) &&
        ...
        Objects.equals(this.additionalProperties, licenseVideo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authCookie, editorialAcknowledgement, metadata, price, searchId, showModal, size, subscriptionId, videoId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LicenseVideo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LicenseVideo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LicenseVideo>() {
           ...
           public LicenseVideo read(JsonReader in) throws IOException {
             ...
             LicenseVideo instance = thisAdapter.fromJsonTree(jsonObj);
