 ...
 */
@ApiModel(description = "AI-powered insights about how the asset will perform for the objective and audience")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ImageInsights {
  ...
  **/
   ...
   * @return the ImageInsights instance itself
   */
  public ImageInsights putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.labels, imageInsights.labels)&&
        Objects.equals(this.additionalProperties, imageInsights.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageInsights
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageInsights.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImageInsights>() {
           ...
           public ImageInsights read(JsonReader in) throws IOException {
             ...
             ImageInsights instance = thisAdapter.fromJsonTree(jsonObj);
