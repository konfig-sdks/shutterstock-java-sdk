 ...
 */
@ApiModel(description = "Access token details that are currently associated with this user")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccessTokenDetails {
  ...
  **/
  ...
  @ApiModelProperty(example = "c456b-26230-fa8ed-d19ab-05ce2-bf0aa", value = "Client ID that is associated with the user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Contributor ID that is associated with the user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456789", value = "Customer ID that is associated with the user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3600", value = "Number of seconds until the access token expires; no expiration if this value is null")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Organization ID that is associated with the user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CUSTOMER", value = "Type of access token")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Scopes that this access token provides when used as authentication")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456789", value = "User ID that is associated with the user")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "jdoe", value = "User name that is associated with the user")
   ...
   * @return the AccessTokenDetails instance itself
   */
  public AccessTokenDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, accessTokenDetails.clientId) &&
        ...
        Objects.equals(this.additionalProperties, accessTokenDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientId, contributorId, customerId, expiresIn, organizationId, realm, scopes, userId, username, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccessTokenDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccessTokenDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccessTokenDetails>() {
           ...
           public AccessTokenDetails read(JsonReader in) throws IOException {
             ...
             AccessTokenDetails instance = thisAdapter.fromJsonTree(jsonObj);
