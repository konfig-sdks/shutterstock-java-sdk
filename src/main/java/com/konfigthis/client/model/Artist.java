 ...
 */
@ApiModel(description = "Metadata about the artist that created the media")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Artist {
  ...
  **/
  ...
  @ApiModelProperty(example = "The Happy Tunes Band", required = true, value = "The artist's name")
   ...
   * @return the Artist instance itself
   */
  public Artist putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, artist.name)&&
        Objects.equals(this.additionalProperties, artist.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Artist
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Artist.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Artist>() {
           ...
           public Artist read(JsonReader in) throws IOException {
             ...
             Artist instance = thisAdapter.fromJsonTree(jsonObj);
