 ...
 */
@ApiModel(description = "Search entity request data")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SearchEntitiesRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "Planting flowers is a great way to make springtime more beautiful.", required = true, value = "Plain text to extract keywords from")
   ...
   * @return the SearchEntitiesRequest instance itself
   */
  public SearchEntitiesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.text, searchEntitiesRequest.text)&&
        Objects.equals(this.additionalProperties, searchEntitiesRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchEntitiesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchEntitiesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchEntitiesRequest>() {
           ...
           public SearchEntitiesRequest read(JsonReader in) throws IOException {
             ...
             SearchEntitiesRequest instance = thisAdapter.fromJsonTree(jsonObj);
